...
for file in files_val:
    ...
    imwrite(f"{save}/{file}_dist_gaussian.JPEG", after_gauss)
    ...
    imwrite(f"{save}/{file}_dist_grayscale.JPEG", after_grayscale)
    ...
    imwrite(f"{save}/{file}_dist_negative.JPEG", after_negative)
    ...
    imwrite(f"{save}/{file}_dist_zoom.JPEG", after_zoom)
